...
export async function POST(request: Request) {
  try {
    ...
    if (!captchaToken) {
      return NextResponse.json(
        { error: 'Güvenlik doğrulaması (reCAPTCHA) eksik. Lütfen robot olmadığınızı doğrulayın.' },
        { status: 400 }
      );
    }
    ...
    const mailOptions: any = {
      ...
      html: `
        <div style="font-family: sans-serif; padding: 20px; color: #333; max-width: 600px; border: 1px solid #eee; border-radius: 8px;">
          <h2 style="color: #E35205; border-bottom: 2px solid #005284; padding-bottom: 10px;">Welltech® B2B Yeni Teklif Talebi</h2>
          ...
          <h3 style="color: #005284; margin-top: 20px;">Proses / Proje Detayları:</h3>
