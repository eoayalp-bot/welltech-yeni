              ...
              <div className="grid md:grid-cols-3 gap-8">
                <div className="md:col-span-2 space-y-6">
                  ...
                  <div className="grid sm:grid-cols-2 gap-4">
                    {[
                      { text: t.features.items[0], icon: <Zap className="w-5 h-5 text-[#E35205]" /> },
                      ...
                      { text: t.features.items[4], icon: <Waves className="w-5 h-5 text-[#E35205]" /> },
                      { text: t.features.items[5], icon: <Cpu className="w-5 h-5 text-[#005284]" /> },
                    ].map((f, idx) => (
              ...
              <div className="md:col-span-2 overflow-x-auto">
                ...
                <table className="w-full text-left border-collapse min-w-[300px]">
                  ...
                  <tbody className="text-sm text-gray-700">
                    {t.table.rows.map((row: { type: string; principle: string; usage: string; highlight: string }, i: number) => (
                      <tr key={i} className="border-b hover:bg-gray-50 transition-colors">
                        ...
                        <td className="p-4">{row.principle}</td>
