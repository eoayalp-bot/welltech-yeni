...
export async function generateMetadata({ params }: { params: Promise<{ lang: string }> }) {
  ...
  return {
    title: "Endüstri Yayınları & Blog | Welltech®",
    description: "Paslanmaz çelik proses teknolojileri, mühendislik standartları ve endüstriyel çözümler hakkında güncel makaleler.",
  };
}
...
export default async function BlogPage({ params }: { params: Promise<{ lang: string }> }) {
  ...
  const jsonLd = {
    ...
    "@type": "Blog",
    "name": "Endüstri Yayınları & Blog | Welltech®",
    "description": "Paslanmaz çelik proses teknolojileri, mühendislik standartları ve endüstriyel çözümler hakkında güncel makaleler.",
    "publisher": {
      "@type": "Organization",
      ...
      <section className="relative h-[85vh] min-h-[600px] flex flex-col justify-center items-center text-center px-6 overflow-hidden">
        <div className="absolute inset-0 z-0">
          <Image
            ...
            alt="Endüstri Yayınları ve Blog"
            fill
            priority
        ...
        <div className="relative z-20 max-w-4xl mx-auto w-full mt-16">
          <div className="flex items-center justify-center gap-2 text-[10px] md:text-xs font-bold tracking-widest text-blue-200 mb-6">
            ...
            <ChevronRight className="w-3 h-3" />
            <span className="text-white">Endüstri Yayınları</span>
          </div>
          ...
          <p className="text-lg md:text-2xl text-white font-medium max-w-3xl mx-auto leading-relaxed drop-shadow-2xl">
            Mühendislik kadromuzun hazırladığı teknik makaleler, sektörel gelişmeler ve proses teknolojilerine dair detaylı analizler.
          </p>
        </div>
      </section>
                  ...
                  <div className="flex flex-col md:flex-row">
                    ...
                    <div className="w-full md:w-1/3 bg-[#0b1120] relative overflow-hidden flex-shrink-0 min-h-[240px]">
                      ...
                      <div className="absolute inset-0 flex flex-col items-center justify-center p-6 text-center z-10 transform group-hover:scale-110 transition-transform duration-700">
                        ...
                        <span className="text-[10px] font-bold tracking-widest text-gray-300 bg-black/60 px-3 py-1 rounded-full border border-gray-600">Teknik Makale</span>
                      </div>
                    </div>
                    ...
                    <div className="p-8 flex flex-col justify-between flex-grow">
                      ...
                      <div className="mt-auto pt-6 border-t border-gray-100 flex items-center justify-between">
                        ...
                        <Link href={`/${lang}/blog/${post.slug}`} className="inline-flex items-center gap-2 text-xs font-bold tracking-widest text-[#005284] group-hover:text-[#E35205] transition-colors">
                          Makaleyi Oku
          ...
          <div className="lg:col-span-4 space-y-8">
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg border border-gray-100 sticky top-24">
              <h3 className="text-lg font-bold text-gray-900 mb-6 tracking-tight flex items-center gap-2 border-b border-gray-100 pb-4">
                ...
                Mühendislik Kategorileri
              </h3>
              <ul className="space-y-4">
                {[
                  { name: "Malzeme Bilimi", count: "1" },
                  { name: "Hijyenik Tasarım", count: "1" },
                  { name: "Mühendislik Standartları", count: "1" },
                  { name: "Kimya Endüstrisi", count: "1" }
                ].map((cat, i) => (
                  <li key={i}>
              ...
              <div className="mt-10 bg-[#005284] p-8 rounded-xl shadow-lg relative overflow-hidden">
                ...
                <div className="relative z-10 text-white">
                  <h3 className="text-xl font-bold mb-3 tracking-tight">E-Bülten Aboneliği</h3>
                  <p className="text-sm text-blue-100 leading-relaxed mb-6">Sektörel standart değişiklikleri ve yeni teknolojilerden anında haberdar olmak için mail listemize katılın.</p>
