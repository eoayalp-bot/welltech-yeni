...
export async function generateMetadata({ params }: { params: Promise<{ lang: string }> }) {
  ...
  return {
    title: "Mühendislik Referansları & Tamamlanan Projeler | Welltech®",
    description: "Welltech tarafından başarıyla teslim edilen endüstriyel paslanmaz çelik projeleri ve saha mühendislik referansları.",
  };
}
...
export default async function ReferencesPage({ params }: { params: Promise<{ lang: string }> }) {
  ...
  const jsonLd = {
    ...
    "@type": "CollectionPage",
    "name": "Mühendislik Referansları ve Tamamlanan Projeler",
    "description": "Welltech tarafından başarıyla teslim edilen endüstriyel paslanmaz çelik projeleri ve saha mühendislik referansları.",
    "publisher": {
      "@type": "Organization",
    ...
    <div className="bg-gray-50 pb-24 selection:bg-[#E35205] selection:text-white">
      ...
      <section className="relative h-[65vh] min-h-[500px] flex flex-col justify-center items-center text-center px-6 overflow-hidden">
        <div className="absolute inset-0 z-0">
          <Image
            src="/assets/images/kurumsal/referanslar-banner.webp"
            alt="Mühendislik Referansları"
            fill
            priority
        ...
        <div className="relative z-20 max-w-4xl mx-auto w-full mt-16">
          <div className="flex items-center justify-center gap-2 text-[10px] md:text-xs font-bold tracking-widest text-blue-200 mb-6">
            ...
            <span className="text-[#E35205]">Referanslar</span>
          </div>
          ...
          <p className="text-lg md:text-2xl text-blue-50 font-medium max-w-3xl mx-auto leading-relaxed drop-shadow-2xl italic">
      ...
      <section className="max-w-7xl mx-auto px-6 py-20 -mt-16 relative z-30">
              ...
              <div className="w-full lg:w-3/5 p-8 md:p-12 flex flex-col justify-center">
                ...
                <div className="flex flex-wrap items-center gap-6 mb-4 text-[11px] font-bold tracking-widest text-gray-400 uppercase">
                  <span className="flex items-center gap-2">
                    <Calendar className="w-4 h-4 text-[#E35205]" /> {project.year}
                  </span>
                  <span className="flex items-center gap-2">
                    <MapPin className="w-4 h-4 text-[#E35205]" /> {project.client}
                  </span>
                </div>

                <h2 className="text-2xl md:text-3xl font-black text-gray-900 mb-4 tracking-tight group-hover:text-[#005284] transition-colors">
                  {project.title}
                </h2>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 py-6 border-y border-gray-100 mb-8 bg-gray-50/50 rounded-lg px-4">
                  <div className="flex flex-col gap-1.5">
                    <span className="text-[10px] font-bold tracking-widest text-[#E35205] uppercase">Kapasite</span>
                    <span className="text-xs font-bold text-gray-800">{project.technical.capacity}</span>
                  </div>
                  <div className="flex flex-col gap-1.5">
                    <span className="text-[10px] font-bold tracking-widest text-[#E35205] uppercase">Malzeme</span>
                    <span className="text-xs font-bold text-gray-800">{project.technical.material}</span>
                  </div>
                  <div className="flex flex-col gap-1.5">
                    <span className="text-[10px] font-bold tracking-widest text-[#E35205] uppercase">Standart</span>
                    <span className="text-xs font-bold text-gray-800">{project.technical.standards}</span>
                  </div>
                  <div className="flex flex-col gap-1.5">
                    <span className="text-[10px] font-bold tracking-widest text-[#E35205] uppercase">Öne Çıkan</span>
                    <span className="text-xs font-bold text-gray-800">{project.technical.features}</span>
                  </div>
                </div>

                <Link href={`/${lang}/iletisim`} className="mt-auto inline-flex items-center gap-3 text-xs font-bold tracking-widest text-[#005284] hover:text-[#E35205] transition-all group/btn uppercase w-max">
                  Aynı Standartta Teklif Al 
        ...
        <div className="mt-20 bg-gray-900 rounded-2xl p-10 lg:p-14 relative overflow-hidden flex flex-col md:flex-row items-center justify-between shadow-2xl">
          ...
          <div className="relative z-10 mb-8 md:mb-0 max-w-2xl flex items-start gap-5">
            ...
            <div>
              <h4 className="text-2xl lg:text-3xl font-black text-white tracking-tight mb-4">Sizin Projeniz İçin Mühendislik Çözümü Üretelim</h4>
              <p className="text-gray-400 leading-relaxed text-sm sm:text-base">
                Spesifik kapasite ihtiyaçlarınız ve teknik standartlarınız için uzman kadromuzla iletişime geçin. Global standartlarda imalat planlamanızı yapalım.
              </p>
            </div>
          </div>
          ...
          <Link 
            href={`/${lang}/iletisim`} 
            className="relative z-10 shrink-0 bg-[#E35205] text-white px-8 py-4 rounded-xl text-sm font-bold tracking-widest hover:bg-white hover:text-[#E35205] transition-all shadow-lg hover:shadow-xl uppercase"
          >
            Teknik Destek Alın
          </Link>
        </div>
