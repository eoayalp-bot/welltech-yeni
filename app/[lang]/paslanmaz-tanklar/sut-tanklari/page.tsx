...
import { getLocalizedUrl, getDocumentPath } from '../../../../dictionaries/routes';
          ...
          <div className="lg:col-span-1 space-y-6">
            <div className="sticky top-24 space-y-6">
              ...
              <div className="bg-white p-6 rounded-xl shadow-lg border-t-4 border-[#E35205]">
                ...
                <a href={specPdfUrl} download className="w-full flex items-center justify-center gap-2 bg-[#005284] text-white px-4 py-3 rounded text-sm font-bold tracking-wider hover:bg-[#E35205] transition-colors shadow-md">
