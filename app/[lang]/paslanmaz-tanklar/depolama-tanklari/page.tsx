...
export default async function StorageTanksPage({ params }: { params: Promise<{ lang: string }> }) {
  ...
  const jsonLd = {
    ...
    "@type": "Product",
    "name": dict.storageTanksPage.metadata.title,
    "image": "https://www.welltech.com.tr/assets/images/paslanmaz-tanklar/depolama/banner.webp",
    "description": dict.storageTanksPage.metadata.description,
  ...
  const featuresList = [
    { text: dict.storageTanksPage.features.items["1"], icon: <Maximize className="w-5 h-5 text-[#E35205]" /> },
    { text: dict.storageTanksPage.features.items["2"], icon: <ShieldCheck className="w-5 h-5 text-[#005284]" /> },
    { text: dict.storageTanksPage.features.items["3"], icon: <CheckCircle className="w-5 h-5 text-[#E35205]" /> },
    { text: dict.storageTanksPage.features.items["4"], icon: <Anchor className="w-5 h-5 text-[#005284]" /> },
    { text: dict.storageTanksPage.features.items["5"], icon: <Shield className="w-5 h-5 text-[#E35205]" /> },
    { text: dict.storageTanksPage.features.items["6"], icon: <Database className="w-5 h-5 text-[#005284]" /> }
  ];
  ...
  const projectsList = [
    { src: "galeri-1.webp", title: dict.storageTanksPage.projects.p1, alt: dict.storageTanksPage.projects.p1 },
    { src: "galeri-2.webp", title: dict.storageTanksPage.projects.p2, alt: dict.storageTanksPage.projects.p2 },
    { src: "galeri-3.webp", title: dict.storageTanksPage.projects.p3, alt: dict.storageTanksPage.projects.p3 },
    { src: "galeri-4.webp", title: dict.storageTanksPage.projects.p4, alt: dict.storageTanksPage.projects.p4 }
  ];
    ...
    <div className="bg-gray-50 pb-24 selection:bg-[#E35205] selection:text-white">
      ...
      <section className="relative h-[65vh] pt-32 pb-20 px-6 overflow-hidden">
        <div className="absolute inset-0 z-0">
          <Image src="/assets/images/paslanmaz-tanklar/depolama/banner.webp" alt={dict.storageTanksPage.hero.title} fill priority className="object-cover transition-transform duration-[3000ms] scale-105" sizes="100vw" />
        ...
        <div className="max-w-7xl mx-auto relative z-10 h-full flex flex-col justify-center">
          <div className="flex items-center gap-2 text-[10px] md:text-xs font-bold tracking-widest text-blue-200 mb-6">
            <Link href={`/${lang}`} className="hover:text-white transition-colors">{dict.storageTanksPage.breadcrumb.home}</Link>
            <ChevronRight className="w-3 h-3" />
            <Link href={getLocalizedUrl('paslanmaz-tanklar', lang)} className="hover:text-white transition-colors">{dict.storageTanksPage.breadcrumb.tanks}</Link>
            <ChevronRight className="w-3 h-3" />
            <span className="text-[#E35205]">{dict.storageTanksPage.breadcrumb.current}</span>
          </div>
          ...
          <div className="lg:col-span-2 space-y-10">
            ...
            <div className="bg-white p-8 md:p-10 rounded-xl shadow-lg border border-gray-100 grid md:grid-cols-2 gap-8 items-center">
              <div>
                <h2 className="text-2xl font-black text-gray-900 mb-6 tracking-tight flex items-center gap-3">
                  ...
                  {dict.storageTanksPage.engineering.title}
                </h2>
                <p className="text-gray-600 leading-relaxed text-sm mb-6">{dict.storageTanksPage.engineering.desc}</p>
              </div>
              <div className="relative h-64 sm:h-80 w-full overflow-hidden border border-gray-100 rounded-lg shadow-inner group">
                <Image src="/assets/images/paslanmaz-tanklar/depolama/mega-tank.webp" alt={dict.storageTanksPage.engineering.title} fill className="object-cover transition-transform duration-700 group-hover:scale-105" sizes="(max-width: 768px) 100vw, 50vw" />
              </div>
            </div>
            ...
            <div className="bg-white p-8 md:p-10 rounded-xl shadow-lg border border-gray-100 overflow-hidden">
              <div className="grid md:grid-cols-3 gap-8">
                <div className="md:col-span-2 space-y-6">
                  <h2 className="text-xl font-bold text-gray-900 mb-4 tracking-tight">{dict.storageTanksPage.features.title}</h2>
                ...
                <div className="relative h-48 md:h-full w-full overflow-hidden border border-gray-100 rounded-lg shadow-inner group">
                  <Image src="/assets/images/paslanmaz-tanklar/depolama/guvenlik.webp" alt={dict.storageTanksPage.features.title} fill className="object-cover transition-transform duration-700 group-hover:scale-105" sizes="(max-width: 768px) 100vw, 33vw" />
                </div>
              </div>
            </div>
            ...
            <div className="bg-white p-8 md:p-10 rounded-xl shadow-lg border border-gray-100 grid md:grid-cols-3 gap-8 items-center">
              <div className="relative h-64 sm:h-96 w-full overflow-hidden border border-gray-100 rounded-lg shadow-sm group">
                <Image src="/assets/images/paslanmaz-tanklar/depolama/cizim.webp" alt={dict.storageTanksPage.capacityTable.title} fill className="object-cover transition-transform duration-700 group-hover:scale-105" sizes="(max-width: 768px) 100vw, 33vw" />
              </div>
              <div className="md:col-span-2 overflow-x-auto">
                <h3 className="text-xl font-bold text-gray-900 mb-6 tracking-tight border-b pb-4">{dict.storageTanksPage.capacityTable.title}</h3>
                <p className="text-xs text-gray-400 mb-4 italic leading-relaxed">{dict.storageTanksPage.capacityTable.note}</p>
                <table className="w-full text-left border-collapse min-w-[300px]">
                  <thead>
                    <tr className="bg-gray-50 text-gray-500 text-xs tracking-widest">
                      <th className="p-4 border-b">{dict.storageTanksPage.capacityTable.headers.volume}</th>
                      <th className="p-4 border-b">{dict.storageTanksPage.capacityTable.headers.diameter}</th>
                      <th className="p-4 border-b">{dict.storageTanksPage.capacityTable.headers.height}</th>
                      <th className="p-4 border-b">{dict.storageTanksPage.capacityTable.headers.material}</th>
                    </tr>
                  </thead>
                  <tbody className="text-sm text-gray-700">
                    ...
                    <tr className="border-b hover:bg-gray-50 transition-colors">
                      ...
                      <td className="p-4" colSpan={3}>{dict.storageTanksPage.capacityTable.onSite}</td>
                    </tr>
                  </tbody>
                </table>
              </div>
            ...
            <div className="bg-white p-8 md:p-10 rounded-xl shadow-lg border border-gray-100">
              <h2 className="text-2xl font-black text-gray-900 mb-8 tracking-tight flex items-center gap-3">
                ...
                {dict.storageTanksPage.faq.title}
              </h2>
              <div className="space-y-6">
                {dict.storageTanksPage.faq.items.map((faq: { q: string; a: string }, i: number) => (
            ...
            <div className="bg-transparent">
              <h2 className="text-2xl md:text-3xl font-black text-gray-900 mb-8 tracking-tight border-b-2 border-gray-200 pb-4">
                {dict.storageTanksPage.projects.title}
              </h2>
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                {projectsList.map((item, index) => (
                  <div key={index} className="relative h-64 sm:h-80 w-full overflow-hidden rounded-xl shadow-md group cursor-pointer">
                    <Image src={`/assets/images/paslanmaz-tanklar/depolama/${item.src}`} alt={item.alt} fill className="object-cover transition-transform duration-700 group-hover:scale-110" sizes="(max-width: 768px) 100vw, (max-width: 1024px) 50vw, 25vw" />
            ...
            <div className="sticky top-24 space-y-6">
              ...
              <div className="bg-white p-6 rounded-xl shadow-lg border-t-4 border-[#E35205]">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    <h4 className="font-bold text-gray-900">{dict.storageTanksPage.sidebar.spec.title}</h4>
                    <p className="text-xs text-gray-500 tracking-widest">{dict.storageTanksPage.sidebar.spec.subtitle}</p>
                  </div>
                </div>
              ...
              <div className="bg-gray-900 p-6 rounded-xl shadow-lg text-white">
                <h4 className="font-bold text-lg mb-2 flex items-center gap-2">
                  ...
                  {dict.storageTanksPage.sidebar.cta.title}
                </h4>
                <p className="text-sm text-gray-400 mb-6 leading-relaxed">{dict.storageTanksPage.sidebar.cta.desc}</p>
                <a href={`https://wa.me/905324125152?text=${encodeURIComponent(dict.storageTanksPage.sidebar.cta.whatsappMsg)}`} target="_blank" rel="noopener noreferrer" className="w-full block text-center bg-[#E35205] text-white px-4 py-3 rounded-xl text-sm font-bold tracking-wider hover:bg-white hover:text-[#E35205] transition-colors shadow-md">
                  {dict.storageTanksPage.sidebar.cta.btn}
                </a>
              </div>
